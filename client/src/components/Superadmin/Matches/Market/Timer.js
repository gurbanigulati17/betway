...
const schema = yup.object({
    timer: yup.number()
        ...
        .max(30, <p style={{ color: 'red' }}>Timer greater than half a minute</p>)
    ...
    return (
        <Formik
            ...
            onSubmit={(data, { setErrors, resetForm, setSubmitting }) => {
                ...
                axios.put('/superadmin/setFancyTimer', payload, { headers: { Authorization: 'Bearer ' + localStorage.getItem('a_token') } })
                    .then(response => {
